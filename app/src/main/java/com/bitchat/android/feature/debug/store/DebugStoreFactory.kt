...
internal class DebugStoreFactory(
    ...
    private sealed interface Message {
        ...
        data class DebugMessagesUpdated(val messages: List<com.bitchat.android.ui.debug.DebugMessage>) : Message
        data class ScanResultsUpdated(val results: List<com.bitchat.android.ui.debug.DebugScanResult>) : Message
        data class ConnectedDevicesUpdated(val devices: List<com.bitchat.android.ui.debug.ConnectedDevice>) : Message
        data class RelayStatsUpdated(val stats: com.bitchat.android.ui.debug.PacketRelayStats) : Message
