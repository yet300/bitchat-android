...
class MeshForegroundService : Service() {
    ...
    override fun onCreate() {
        ...
        if (existing != null) {
            ...
            val created = MeshServiceHolder.getOrCreate(applicationContext, appGraph.debugSettingsManager, appGraph.debugPreferenceManager, appGraph.seenMessageStore, appGraph.transferProgressManager)
    ...
    private fun ensureMeshStarted() {
        ...
        try {
            ...
            val service = MeshServiceHolder.getOrCreate(applicationContext, appGraph.debugSettingsManager, appGraph.debugPreferenceManager, appGraph.seenMessageStore, appGraph.transferProgressManager)
