...
- [x] 2. Extract GeohashMessageHandler from GeohashViewModel
...
- [x] 3. Add geohash state to ChatStore.State
...
- [x] 4. Add geohash intents to ChatStore
...
- [x] 5. Implement geohash operations in ChatStoreFactory
...
- [x] 6. Update LocationChannelsStoreFactory
...
- [x] 7. Remove GeohashViewModel from ChatStoreFactory
  - Remove geohashViewModel injection
...
- [x] 9. Delete GeohashViewModel and related files
